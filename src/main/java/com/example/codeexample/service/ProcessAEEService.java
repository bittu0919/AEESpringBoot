...
public class ProcessAEEService {
	...
	public String getOrgInfoByName(String orgName) throws IOException, JSONException {
	...
	public String getOrgInfoByReleaseCount(String count) throws IOException, JSONException {
		Collection<Organisation> orgData = getJsonFromSource();
		ArrayList<Organisation> matchedList= new ArrayList<Organisation>();
		for(Organisation org : orgData) {
	...
	public String getOrgInfoByTotalhours(String hours) throws IOException, JSONException {
		Collection<Organisation> orgData = getJsonFromSource();
		ArrayList<Organisation> matchedList= new ArrayList<Organisation>();
		for(Organisation org : orgData) {
